...
Thanks for using overtureR! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/arthurgailes/overtureR/issues/new).
...
requests](https://github.com/arthurgailes/overtureR/issues) to make sure
