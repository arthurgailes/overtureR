...
Afterwards, `collect` brings only the data you need into memory. For more on lazy programming, see the [dbplyr documentation](https://dbplyr.tidyverse.org/).
