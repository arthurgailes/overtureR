...
This outlines how to propose a change to overtureR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("arthurgailes/overtureR", fork = TRUE)`.
...
Please note that the overtureR project is released with a [Contributor
Code of
Conduct](https://arthurgailes.github.io/overtureR/CODE_OF_CONDUCT.md).
